        ...
        <div className="min-h-screen bg-zinc-50 text-zinc-900">
            <div className="sticky top-0 z-40 bg-white border-b border-zinc-200">
                <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                    ...
                    <button className="px-4 py-2 rounded-lg border border-zinc-300 text-sm hover:bg-zinc-100 transition" onClick={() => router.push("/dashboard")}>
                        Go to Dashboard
                    </button>
                </div>
            </div>
            ...
            <div className="flex justify-center px-4 py-14">
                ...
                >
                    ...
                    <div className="relative bg-zinc-900 text-zinc-100 rounded-xl p-5 text-sm font-medium mt-2 mb-10">
                        <pre>
                            {embedCode}
                        </pre>
