...
function HomeClient({ email }: { email: string}) {
    ...
    return (
        <div className='min-h-screen bg-linear-to-br from-white to-zinc-50 text-zinc-900 overflow-x-hidden'>
            ...
            <section className="md:pt-45 pt-32 pb-24 md:pb-28 px-6">
                <div className="max-w-340 mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
                    ...
                    >
                        <h1 className="text-[34px] md:text-[53px] font-semibold leading-tight">
                        ...
                        <p className="mt-6 text-lg text-zinc-600 max-w-xl">
                            ...
                            Let your customers get instant answers using your own bussiness knowledge.
                        </p>
                        ...
                        <div className="mt-10 flex gap-4">
                            ...
                            <a href="#feature" className="px-7 py-3 rounded-xl border border-zinc-300 text-zinc-700 font-semibold md:py-5 hover:bg-zinc-100 text-center transition">
                                Learn More
                            </a>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="rounded-2xl bg-white shadow-2xl border border-zinc-200 p-6">
                            <div className="text-regular text-zinc-500 mb-3 shadow-2xl">
                                Live Chat Preview
                            </div>
            ...
            <section
                id="feature"
                className="bg-zinc-50 md:py-28 pt-20 pb-10 px-6 border-t border-zinc-200"
            >   
            ...
            <footer className="py-10 text-center text-sm text-zinc-500">
                &copy; { new Date().getFullYear() } <span className="text-zinc-900">Support.ai</span> All rights reserved.
            </footer>
        </div>
    )
}
